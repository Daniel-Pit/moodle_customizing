...
function user_get_user_navigation_info($user, $page, $options = array()) {
    ...
    //Start - add by Guang Jin
    // Links: Public Info.
    $mypublicinfo = new stdClass();
    $mypublicinfo->itemtype = 'link';
    $newurl=$CFG->wwwroot."/users/". $user->username."/badges";
    $mypublicinfo->url = new moodle_url($newurl);
    $mypublicinfo->title = 'Public Info';
    $mypublicinfo->titleidentifier = 'mymoodle,admin';
    $mypublicinfo->pix = "i/badge";
    $returnobject->navitems[] = $mypublicinfo;
    //End
    // Links: My Profile.
