...
//Start  Added by Guang Jin
$string['qualification'] = 'Qualification';
$string['qualification_help'] = 'Describes what qualifications are conferred upon passing this course.<br> Ex:Qualified for Junior Software Quality Assurance Specialist (manual testing) position';
$string['missingqualification'] = 'Missing qualification';
$string['issuername'] = 'Issuer Name';
$string['issuername_help'] = 'Write the name of the issuer of the certificate awarded upon passing this course.';
$string['missingissuername'] = 'Missing issuer name';
$string['issuerposition'] = 'Issuer Position';
$string['issuerposition_help'] = 'Write the position of the issuer of the certificate awarded upon passing this course.';
$string['missingissuerposition'] = 'Missing issuer position';
$string['certification']='Certification';
//End  Added by Guang Jin